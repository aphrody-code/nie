...
//! (`plugins/nie-blender/g4mt_probe.py`/`g4mt_motion.py`, submodule tiers) sur des fichiers réels du VFS.
...
mod tests {
    ...
    /// Golden croisé contre l'implémentation Python indépendante (`plugins/nie-blender`, submodule)
