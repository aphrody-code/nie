...
//! - Données : `/home/ubuntu/nie/data/common/gamedata/character/growth_table_config_0.00.00.00.cfg.bin.json`
//!   et export agrégé `/home/ubuntu/nie/data/all-gamedata/growth_tables.json` (mêmes 4 listes :
