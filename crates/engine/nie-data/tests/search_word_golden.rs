...
const REAL_SEARCH_WORD: &str =
    "/home/ubuntu/niers/data/common/gamedata/search_word/search_word_config.cfg.bin.json";
const REAL_INFO_BOOKMARK: &str =
    "/home/ubuntu/niers/data/common/gamedata/search_word/info_bookmark_config_0.00.00.cfg.bin.json";
