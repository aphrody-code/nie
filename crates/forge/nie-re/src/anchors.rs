...
fn classify_game_class(lower_name: &str) -> Option<&'static str> {
    ...
    if lower_name.starts_with("cgdd")
        ...
        || lower_name.starts_with("bonussoccer")
        || lower_name.starts_with("godhand")
        || lower_name.starts_with("inazumaflower")
        || lower_name.starts_with("victoryroad")
        || lower_name.starts_with("soccer")
        || lower_name.starts_with("team")
        || lower_name.starts_with("craft")
        || lower_name.starts_with("gamechat")
        || lower_name.starts_with("inventory")
