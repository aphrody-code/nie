...
export function MenuPipelinePanel({ baseUrl }: { baseUrl: string }) {
  const [screen, setScreen] = useState("chara_edit_list_menu");
  ...
  return (
    <section className="border-b border-app-line bg-app-dark-box px-2 py-1.5" aria-label="Rendu de menu">
      <div className="flex items-center gap-2">
        ...
        <button type="button" className="h-7 rounded bg-accent px-2 text-tiny font-medium text-white disabled:opacity-50" disabled={loading} onClick={render}>
