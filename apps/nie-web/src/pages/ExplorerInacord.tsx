...
export function ExplorerInacord({ onHome }: ExplorerInacordProps) {
	...
	const mainSections = [
		...
		{ label: "OUTILS", items: [{ id: "media", label: "Galerie", icon: <MaterialIcon name="gallery_thumbnail" />, onClick: () => navigateTool("medias") }, { id: "models", label: "Modèles", icon: <MaterialIcon name="view_in_ar" />, onClick: () => navigateTool("modeles") }, { id: "textures", label: "Textures", icon: <MaterialIcon name="image" />, onClick: () => navigateTool("textures") }, { id: "inacord-app", label: "Inacord App", icon: <MaterialIcon name="open_in_new" />, onClick: () => window.open("https://inacord.aphrody.com", "_blank") }] },
