...
describe("native opening movies", () => {
	...
	test("the mounted game advances each logo only once after both tracks end", async () => {
		const phases: string[] = [];
		const callbacks = { onPhaseChange: (phase: string) => phases.push(phase), onOpenBank() {}, onOpenGallery() {}, onOpenShop() {}, onOpenAvatar() {}, onOpenSettings() {}, onOpenMedia() {}, onOpenExplorer() {}, onOpenEditor() {}, onOpenSearch() {}, onOpenData() {} };
