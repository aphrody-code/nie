...
import { biseau, BOITES, LARGEUR_TUILE, PENTE_PANNEAU } from "./main-menu-geometry";
	...
	return (
		<div
			style={{
				...
				transform: ancreX || ancreY ? `translate(${-ancreX * 100}%, ${-ancreY * 100}%)` : undefined,
				zIndex: z,
				...style,
			}}
		>
...
export function TileStrip({ children, ecart = 8 }: { children: ReactNode; ecart?: number }) {
	return (
		<div
			style={{ display: "flex", justifyContent: "center", alignItems: "flex-start", gap: ecart }}
		>
			{children}
		</div>
	);
		...
		<div style={{ textAlign: "center", color: "var(--jeu-texte-vif)" }}>
			...
			<div
				style={{
					...
					marginTop: 2,
					padding: "2px 22px",
					background: "linear-gradient(180deg, var(--jeu-plaque-bleu), var(--jeu-nuit-profonde))",
					fontSize: 34,
					fontWeight: 800,
					lineHeight: 1.1,
