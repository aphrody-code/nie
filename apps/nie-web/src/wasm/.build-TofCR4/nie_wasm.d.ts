...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_3963: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3978: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2994: (a: number, b: number, c: number) => void;
