// brand-icons.tsx — réintroduit les icônes de marque retirées par lucide-react 1.x
// (Twitter, Instagram, Twitch, Youtube, Facebook, Github, Linkedin) en composants
// 100% lucide-compatibles via `createLucideIcon` (mêmes props size/color/className/strokeWidth).
// Chemins SVG = définitions lucide classiques (avant suppression des brand icons).
...
export const Twitch = createLucideIcon("Twitch", [
	["path", { d: "M21 2H3v16h5v4l4-4h5l4-4V2z", key: "tc1" }],
	["path", { d: "M11 11V7M16 11V7", key: "tc2" }],
]);
...
export const Facebook = createLucideIcon("Facebook", [
	[
		"path",
		{ d: "M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z", key: "fb1" },
	],
]);
...
export const Linkedin = createLucideIcon("Linkedin", [
	["path", { d: "M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z", key: "li1" }],
