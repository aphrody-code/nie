...
function FloatingLinkEditor({
	...
	return (
		<div
			ref={editorRef}
			className="absolute top-0 left-0 w-full max-w-sm rounded-md bg-background shadow-md z-50 pointer-events-auto"
			style={{ opacity: 0 }}
			role="dialog"
			aria-label="Éditeur de lien"
		>
