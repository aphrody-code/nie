...
context: fork
compatibility: Primarily uses the Microsoft Learn MCP Server (https://learn.microsoft.com/api/mcp); if that is unavailable, fall back to the mslearn CLI (`bunx @microsoft/learn-cli`).
---
...
bunx @microsoft/learn-cli search "semantic kernel overview"

# Or install globally, then run
bun add -g @microsoft/learn-cli
...
| --------------------------------- | ------------------ |
| Client library, NuGet/bun package | SDK/Library        |
...
Run directly with `bunx @microsoft/learn-cli <command>` or install globally with `bun add -g @microsoft/learn-cli`.
```
