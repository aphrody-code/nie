...
const INSTRUCTIONS = [
	...
	"Le miroir SQLite est une source locale en lecture seule. Les fichiers et textes bruts du jeu se lisent avec les commandes VFS de `nie-cli`; ils ne sont pas exposés par une seconde logique TypeScript.",
