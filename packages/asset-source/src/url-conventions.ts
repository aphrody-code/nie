/**
 * Le gisement **game** : les fichiers du jeu tels que `nie-model-serve` les décode à la volée.
 *
...
//
// Elles ne sont PAS des routes de `nie-model-serve` (le test `game.test.ts` l'exige) : ce sont
