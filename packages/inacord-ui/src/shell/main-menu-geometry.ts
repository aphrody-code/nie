 ...
 *
 * De `scripts/validation/measure-mainmenu.py`, joue sur
 ...
 *
 * ```
 * uv run scripts/validation/measure-mainmenu.py
 * ```
 *
 ...
 * (`docs/mainmenu01-visual-analysis.md` § 5 : il vient de la machine d'etat C++ `G4RA` et des
