...
`packages/inacord-ui/src/shell/main-menu-geometry.ts` — le script existe pour qu'aucune ne
soit un souvenir.

    uv run scripts/validation/measure-mainmenu.py [capture.png]
...
2. **La pente se lit ligne par ligne, pas par un ajustement de boite.** L'analyse anterieure
   (`docs/mainmenu01-visual-analysis.md`) concluait « angle non mesurable, R2 < 0,45 » parce
