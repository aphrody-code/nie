...
const explicitNativeProof: Record<string, { owner: string; sourceEvidence: [string, string][] }> = {
  ...
  aphrody_pet_etat: { owner: "apps/inacord/src-tauri/src/aphrody.rs", sourceEvidence: [["apps/inacord/src-tauri/src/lib.rs", "aphrody::pet_etat("], ["apps/inacord/src-tauri/src/aphrody.rs", "fn pet_etat"], ["apps/inacord/src-tauri/src/aphrody.rs", "Pet::bundled("]] },
  aphrody_pet_frame_png_b64: { owner: "apps/inacord/src-tauri/src/aphrody.rs", sourceEvidence: [["apps/inacord/src-tauri/src/lib.rs", "aphrody::pet_frame_png_b64("], ["apps/inacord/src-tauri/src/aphrody.rs", "fn pet_frame_png_b64"], ["apps/inacord/src-tauri/src/aphrody.rs", "Pet::bundled("]] },
  aphrody_pixel_tokens_css: { owner: "apps/inacord/src-tauri/src/aphrody.rs", sourceEvidence: [["apps/inacord/src-tauri/src/lib.rs", "aphrody::tokens_css_fichier("], ["apps/inacord/src-tauri/src/aphrody.rs", "fn tokens_css_fichier"], ["apps/inacord/src-tauri/src/aphrody.rs", "tokens_css("]] },
  aphrody_pixel_vectoriser: { owner: "apps/inacord/src-tauri/src/aphrody.rs", sourceEvidence: [["apps/inacord/src-tauri/src/lib.rs", "aphrody::vectoriser_fichier("], ["apps/inacord/src-tauri/src/aphrody.rs", "fn vectoriser_fichier"], ["apps/inacord/src-tauri/src/aphrody.rs", "vectoriser("]] },
