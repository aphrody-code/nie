...
const explicitNativeProof: Record<string, { owner: string; sourceEvidence: [string, string][] }> = {
  ...
  raw_cpk_video_preview_b64: { owner: "crates/engine/nie-formats/src/usm.rs", sourceEvidence: [["apps/inacord/src-tauri/src/lib.rs", "video_mp4_b64_from_bytes("], ["apps/inacord/src-tauri/src/lib.rs", "video::mp4_depuis_usm("], ["apps/inacord/src-tauri/src/video.rs", "use nie_formats::usm"]] },
  vfs_video_preview_b64: { owner: "crates/engine/nie-formats/src/usm.rs", sourceEvidence: [["apps/inacord/src-tauri/src/lib.rs", "fn vfs_video_preview_b64"], ["apps/inacord/src-tauri/src/lib.rs", "video::mp4_depuis_usm("], ["apps/inacord/src-tauri/src/video.rs", "use nie_formats::usm"]] },
};
